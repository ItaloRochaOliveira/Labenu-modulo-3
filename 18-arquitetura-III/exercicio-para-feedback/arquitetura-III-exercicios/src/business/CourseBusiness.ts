...
import {
  DeleteCoursesInputDTO,
  DeleteCoursesOutputDTO,
} from "../dtos/deleteCourse.dto";
import {
  EditCourseInputDTO,
  EditCourseOutputDTO,
} from "../dtos/editCourses.dto";
import {
  GetCoursesInputDTO,
  GetCoursesOutputDTO,
} from "../dtos/getCourses.dto";
...
export class CourseBusiness {
  ...
  public getCourses = async (
    input: GetCoursesInputDTO
  ): Promise<GetCoursesOutputDTO[]> => {
    const { q } = input;
  ...
  public deleteCourse = async (
    input: DeleteCoursesInputDTO
  ): Promise<DeleteCoursesOutputDTO> => {
    ...
    const output: DeleteCoursesOutputDTO = {
