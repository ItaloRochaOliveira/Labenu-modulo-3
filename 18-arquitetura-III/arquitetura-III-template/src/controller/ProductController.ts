...
import { CreateProductScheme } from "../dtos/createProduct.dto";
import { ZodError } from "zod";
import { EditProductScheme } from "../dtos/EditProduct.dto";
import { GetProductScheme } from "../dtos/getProduct.dto";
...
export class ProductController {
  ...
  public createProduct = async (req: Request, res: Response) => {
    try {
      const input = CreateProductScheme.parse({
        id: req.body.id,
        name: req.body.name,
  ...
  public getProducts = async (req: Request, res: Response) => {
    try {
      const input = GetProductScheme.parse({
        q: req.query.q,
      });
  ...
  public editProduct = async (req: Request, res: Response) => {
    try {
      const input = EditProductScheme.parse({
